...
public final class EmployeeServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.wscode.model.EmployeeCheckRequest,
      com.wscode.model.Employee> getGetEmployeeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getEmployee",
      requestType = com.wscode.model.EmployeeCheckRequest.class,
      responseType = com.wscode.model.Employee.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.wscode.model.EmployeeCheckRequest,
      com.wscode.model.Employee> getGetEmployeeMethod() {
    io.grpc.MethodDescriptor<com.wscode.model.EmployeeCheckRequest, com.wscode.model.Employee> getGetEmployeeMethod;
      ...
      synchronized (EmployeeServiceGrpc.class) {
        if ((getGetEmployeeMethod = EmployeeServiceGrpc.getGetEmployeeMethod) == null) {
          EmployeeServiceGrpc.getGetEmployeeMethod = getGetEmployeeMethod = 
              io.grpc.MethodDescriptor.<com.wscode.model.EmployeeCheckRequest, com.wscode.model.Employee>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "EmployeeService", "getEmployee"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.wscode.model.EmployeeCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.wscode.model.Employee.getDefaultInstance()))
  ...
  public static abstract class EmployeeServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getEmployee(com.wscode.model.EmployeeCheckRequest request,
        io.grpc.stub.StreamObserver<com.wscode.model.Employee> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.wscode.model.EmployeeCheckRequest,
                com.wscode.model.Employee>(
  ...
  public static final class EmployeeServiceBlockingStub extends io.grpc.stub.AbstractStub<EmployeeServiceBlockingStub> {
    ...
    /**
     */
    public com.wscode.model.Employee getEmployee(com.wscode.model.EmployeeCheckRequest request) {
  ...
  public static final class EmployeeServiceFutureStub extends io.grpc.stub.AbstractStub<EmployeeServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.wscode.model.Employee> getEmployee(
        com.wscode.model.EmployeeCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_EMPLOYEE:
          serviceImpl.getEmployee((com.wscode.model.EmployeeCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.wscode.model.Employee>) responseObserver);
          break;
        default:
  ...
  private static abstract class EmployeeServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.wscode.model.EmployeeServiceOuterClass.getDescriptor();
    }
